...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Deelnemer Bewerken <a class="btn btn-sm btn-success float-right"
                    ...
                    <div class="card-body">
                        ...
                        {{Form::model($participant, array('route' => array('participants.update', $participant->id)))}}
                        @method('PATCH')
                        @csrf
                        <div class="row">
                            <div class="col-md-5">
